...
public class C04_ArraysAsList {
    public static void main(String[] args) {
        ...
        // UnsupportedOperationException : Desteklenmeyen islem veri
        arr[1] ="Z";
        System.out.println("Array'i degistirdikten sonra, array = " + Arrays.toString(arr));
        System.out.println("Array'i degistirdikten sonra, list = " + arraydanList);


        arraydanList.set(3, "D");
        System.out.println("List'i degistirdikten sonra, list = " + arraydanList);
